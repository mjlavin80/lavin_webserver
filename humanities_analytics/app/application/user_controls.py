...
class ModelViewAdmin(ModelView):
    ...
    form_overrides = dict(page_data=CKEditorField, course_description=CKEditorField, office_hours=CKEditorField, policies=CKEditorField, assignments=CKEditorField, due_dates=CKEditorField, calendar=CKEditorField, lab_schedule=CKEditorField)
