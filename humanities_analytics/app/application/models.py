...
class Syllabus(db.Model):
    ...
    course_name = db.Column(db.String(1024), nullable=False)
    semester = db.Column(db.String(512), nullable=False)
    current = db.Column(db.String(128), default="False", nullable=False)
    ...
    due_dates = db.Column(db.Text(), nullable=False)
